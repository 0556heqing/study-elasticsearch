package com.heqing.elasticsearch.config;
 ...
 */
@Configuration
@ComponentScan("com.heqing.elasticsearch.*")
@EnableElasticsearchRepositories(basePackages = {"com.heqing.elasticsearch.repository"})
